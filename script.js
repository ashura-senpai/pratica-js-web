document.addEventListener('DOMContentLoaded', function() {
    ...
    // Create Header
    const header = createElementWithClass('header', null, document.body);
    const h1 = createElementWithClass('h1', null, header);
    h1.textContent = 'Squirtle';
  
    // Create Navigation
    const nav = createElementWithClass('nav', null, document.body);
    ...
    // Create Main Content
    const main = createElementWithClass('main', null, document.body);
    ...
    // Create Footer
    const footer = createElementWithClass('footer', null, document.body);
